      ...
      <main className="pt-32 pb-20 px-6 max-w-5xl mx-auto">
        ...
        <section className="relative p-10 md:p-16 mb-16 editorial-accent">
          <div className="max-w-3xl">
            ...
            <div className="space-y-6 text-on-surface-variant leading-loose whitespace-pre-wrap">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="bg-primary text-on-primary px-10 py-4 rounded-xl font-medium flex items-center justify-center gap-3 hover:opacity-90 shadow-lg">
